...
form from unconsciousness and organism that are in deep sleep and are dreaming
#### [[Creation Sprite]]
(Class)
...
These sprites are unique in that they not only affect the spirit realm, but will leak into the physical affecting the space around their semantic source of structure.
...
## [[Anima]]
(N/A)
a spirit that forms from a binding within a persons [[Soul]], this spirit can be used as their source of [[Signa]], and an external anchor for their [[Binding]](s) 
...
- do not have a central physical form 
### [[Language Spirit]]
...
(It can be used in many different ways when the spirits talk, and the tone is what makes the difference. For instance, if you say it in an insulting way, it refers to the sneaky manipulative side of being a God. If you say it as a compliment, then it can either refer to the powerful, wise, or complex side of being a God. In some regions of the spirit world, it's how you pronounce it. For example, in one region, if you want to make it insulting, you say “God” stressing the “O” sound.)
#### [[Fates]] 
(Species)
...
- Animals act like their environment to camouflage themselves
...
- rat kings break classification a bit as they are also closely related to socital spirits and gods, but due to the subject of their binding, they behave much differently
#### [[Silicate Jelly]]
(Phylum)
...
#### [[(?)]]
(Phylum)
A creature that lives in the bottom of the ocean that is comprised of a bunch of bioluminescent jellyfish whose tendrils are linked to the others around it, like a spider web hanging in the ocean or a cloud of particles with the connections changing depending on which other particle is closest
### [[Ent]]
half-spirits of the plants
...
#### [[Werebeast]]
(Phylum)
human or dragon [[#Polymorphics]] that have an animal form 
...
most species of demon live in the [[#Deeplakes]], feeding off of the heat and chemicals brought up in volcanic activity
...
- ascended demons have a body temp that is only slightly higher than most other species on [[#Terra (N/P)]], part of the demon solidify when named giving each individual a unique skeletal structure that can be impossible or impractical in normal biology, this process can be guided to 
...
### [[Mimic]]
[[Possessor Spirit]] that inhabits man-made [[Object.Myth]] 
#### [[Lesser Mimic]]
#### [[Greater Mimic]]
a mimic that posses entire man made structures into a castle