...
Spirits will also change based on what they were created out of (the spirit of the forest can be ‘burnt down’). Spirits that are formed around an ecosystem will look like the organism from different animals and the properties of the thing they represent, but can literally look like anything.
...
## [[Anima]]
(N/A)
a spirit that forms a symbiotic relationship with an organisms [[Soul]], using it as an anchor to  a binding within this spirit can be used as their source of [[Signa]], and an external anchor for their [[Binding]](s) 
...
A powerful spirit that has gotten a group or race of people to worship it. When a spirit manipulates the native to worship it, it is titled a God. A deity is tied to a concept and the people that made them 
