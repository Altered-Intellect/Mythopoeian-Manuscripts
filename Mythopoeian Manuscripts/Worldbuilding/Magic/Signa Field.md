...
- because Signa has particle-wave duality, the probability that a Signa particle will affect the system that it is bound to is dependent on structure and energy
...
(removing Signa bindings in a living organism requires surgery something that isn’t widely available and nullifying binding which requires math and precision using sign circles, both which cultures take time developing)
- The ability to artificially break [[#Analogue]] bindings, create [[#Signa Voids]] and [[#Inverse Sign]](s) are ancient secrets in some post-collapse [[Terran Cultures]]cultures
#### [[Signa Void]]
