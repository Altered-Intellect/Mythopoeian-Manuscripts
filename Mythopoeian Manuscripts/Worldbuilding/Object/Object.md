...
sibling docs: 
child docs: 
date created: 2024-09-29T23:14:00
last updated: 2024-09-29T23:14:00
media:
---
### [[Mirror of Aeraseid]]
a mirror that reflects the worst qualities in the things that are reflected in it, according to the system that views it. The system has to be living in some capacity
### [[Teacube]]
an ice cube made by taking a teabag and putting it in an ice tray filled with water, the teabag is left to steep in the water a bit and is then frozen and put in iced tea to keep it cold, people often put other herbs within the tray to keep the flavor strong
### [['Tato towel]]
100% decomposable towels that grow potatoes when planted in the ground, the towels are mostly made of the skin of the potatoes and is the same color brown
### [[Barrier Reel]] (N/P)
...
### [[Golem Core]]
a written pact describing some of the characteristics of the golem
### [[Stormcaller]]
a device that vaguely resembles a clock and sundial that has the ability to predict and to a lesser extent control a storms movement 
- measures the barometric pressure of the atmosphere, the direction of the wind, 
### [[Probability pitcher]]
A glass of thick, almost semi-solid, liquid that when shaken turns into a specified set of dice
...
### [[Bong of Growth]] 
a clay bong filled with [moist] plants, a bong for getting high off of nectar, a colony of [[Growth sprite]](s) live in the water at it bottom, thick with algae, moss, and mushrooms, the ember is encased in amber, needs to be watered and emptied of detritus or else the ecosystem the makes the nectar will die
...
### [[Bag of holding]]
use spatial-temporal bindings, because of this they are virtually immovable and are only affected by gravitational forces and not inertial forces, thus needing an external anchor or the binding will instantly decay, the easier way to make a bag of holding is to make an [inter-planar gate](area that is bent continously into the [Complex Plane]) lightweight enough to carry around
- The first iterations bent space time making time pass faster in the bound space, later versions are able to reverse this using more precise bindings and an extra input of energy
- Someone makes a starship drive using a bag of holding, "your plan is to turn my bag into an engine that can get us to the stars!?!?!" "Well, that and something that can pull energy from the inter-planar medium." "Oh and that's all, sure." "Look, to be fair it's a *very* fancy bag." 
### [[Tellers Ring]]
...
Can cut holes in reality to different realms.
To close it the blades edge must be run perpendicular to the cut and pinched closed
# [[Technology]]

-  Aerogel used in conjunction with copper cooling pipes for computing 
...
made from [[#Sundrop]](s)
### [[Mana potion]] (N/P)
a solution of [[Mana Crystals]] dissolved in water often with herbs or other stimulants for other effects
...
##### [[Stillmetal]]
a metametal that has a [[Complex Temp]] allowing it to keep a set temperature without geting warmer or colder 

##### [[Subzero alloy]]

- meta metal that has a negative temperature : it absorbs heat without warming up, instead transferring the energy into [[Axi]]
...
# [[Stellar Bodies]]
are large enough to produce light through fusion
...
- metals reduce the radius of the explosion, and create flowing patterns of electromagnetic flux that interact with themselves behaving like a fluid fractal like in nature
